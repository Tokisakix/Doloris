...
def _save_fig(title: str, save_dir="outputs/figures/"):
...
def plot_classification_report(report_dict, title="Classification Report"):
    ...
    plt.tight_layout()
    _save_fig("classification_report")
    plt.close()


def plot_avg_scores(report_dict):
    ...
    plt.tight_layout()
    _save_fig("macro_vs_weighted_avg")
    plt.close()
